...
$APPLICATION->SetTitle('Очередь передачи');
...
use Custom\ESB\Server\CESBServerQueueTable;
...
if($arID = $lAdmin->GroupAction()){
    ...
    if($_REQUEST['action_target'] === 'selected'){
        ...
        $terms = CESBServerQueueTable::getList();
    ...
    foreach($arID as $ID) {
        ...
        switch($_REQUEST['action']){
            case 'delete':
                ...
                if(CESBServerQueueTable::delete($ID)){
                    ?>
...
$lAdmin->AddHeaders([
    ...
    ['id' => 'DATE_STARTED', 'content' => 'Старт', 'sort' => 'date_started', 'default' => true, 'align' => 'center'],
    ['id' => 'DATE_COMPLETED', 'content' => 'Финиш', 'sort' => 'date_completed', 'default' => true],
    ['id' => 'PROCESS_STARTED', 'content' => 'Начато', 'sort' => 'process_started', 'default' => true],
    ['id' => 'PROCESS_COMPLETED', 'content' => 'Завершено', 'sort' => 'process_completed', 'default' => true],
    ['id' => 'EMERGENCY_STOP', 'content' => 'Завершено аварийно', 'sort' => 'emergency_stop', 'default' => true],
    ['id' => 'CONNECTION_ERROR', 'content' => 'Ошибка соединения', 'default' => true],
    ['id' => 'CONNECTION_RESULT', 'content' => 'Результат передачи', 'default' => true],
    ['id' => 'CONNECTION_STATUS', 'content' => 'Статус ответа', 'default' => true],
    ['id' => 'COUNTER_TRY', 'content' => 'Количество попыток', 'default' => true],
    ['id' => 'EVENT', 'content' => 'Событие', 'default' => true],
    ['id' => 'OBJECT', 'content' => 'Объект', 'default' => true],
    ['id' => 'VALUE', 'content' => 'Данные', 'default' => true]
]);

$rsData = CESBServerQueueTable::getList([
    'select' => [
        'ID',
        'DATE_COMPLETED',
        'DATE_STARTED',
...
while($arRes = $rsData->NavNext(true))
{
    ...
    $row->AddViewField('VALUE', '<a href="/bitrix/admin/nm_bus_show_data_srv.php?ID='. $arRes['ID'] .'" title="Просмотр данных">'. humanBytes(strlen($arRes['VALUE'])) . '</a>');
}
